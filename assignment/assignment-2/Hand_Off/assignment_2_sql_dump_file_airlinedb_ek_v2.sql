CREATE DATABASE  IF NOT EXISTS `airlinedb_ek_v2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `airlinedb_ek_v2`;
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: localhost    Database: airlinedb_ek_v2
-- ------------------------------------------------------
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `lax_flights` AS select `flights`.`flight_ID` AS `flight_ID`,`customers`.`cust_first_name` AS `cust_first_name`,`customers`.`cust_surname` AS `cust_surname` from ((`flights` join `bookings` on((`flights`.`flight_ID` = `bookings`.`flight_ID`))) join `customers` on((`bookings`.`customer_ID` = `customers`.`customer_ID`))) where (`flights`.`arr_airport_ID` = 'LAX') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `lhr_flights` AS select `flights`.`flight_ID` AS `flight_ID`,`customers`.`cust_first_name` AS `cust_first_name`,`customers`.`cust_surname` AS `cust_surname` from ((`flights` join `bookings` on((`flights`.`flight_ID` = `bookings`.`flight_ID`))) join `customers` on((`bookings`.`customer_ID` = `customers`.`customer_ID`))) where (`flights`.`arr_airport_ID` = 'LHR') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-12-22 12:21:53
